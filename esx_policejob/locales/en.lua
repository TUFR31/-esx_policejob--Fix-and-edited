Locales['en'] = {
  ...
  ['vehicle_spawner'] = 'press ~INPUT_CONTEXT~ to access the ~y~Gargage Actions~s~.',
  ['store_vehicle'] = 'press ~INPUT_CONTEXT~ To Store the ~y~Vehicle~s~.',
  ...
  ['drugs_offences'] = 'Drugs Offences',
  ['weapons_offences'] = 'Weapons Offences',
  ['property_offences'] = 'property/Person Offences',
  ['business_corruptions'] = 'Business Corruptions',
  ['police_offences'] = 'Police Offences',
  ['fine_total'] = 'fine: %s',
  -- Vehicle Info Menu
  ['plate'] = 'plate: %s',
