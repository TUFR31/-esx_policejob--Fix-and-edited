...
function OpenCloakroomMenu()
	...
	elseif grade == 'prob_constable' then
		table.insert(elements, {label = _U('police_wear'), value = 'prob_constable_wear'})
	elseif grade == 'constable' then
		table.insert(elements, {label = _U('police_wear'), value = 'constable_wear'})
	elseif grade == 'snr_constable' then
		table.insert(elements, {label = _U('police_wear'), value = 'snr_constable_wear'})
	elseif grade == 'l_snr_constable' then
		table.insert(elements, {label = _U('police_wear'), value = 'l_snr_constable_wear'})
	elseif grade == 'sergeant_i' then
		table.insert(elements, {label = _U('police_wear'), value = 'sergeant_i_wear'})
	elseif grade == 'sergeant_ii' then
		table.insert(elements, {label = _U('police_wear'), value = 'sergeant_ii_wear'})
	elseif grade == 'sergeant_iii' then
		table.insert(elements, {label = _U('police_wear'), value = 'sergeant_iii_wear'})
	elseif grade == 'boss' then
		table.insert(elements, {label = _U('police_wear'), value = 'boss_wear'})
	elseif grade == 'afp' then
		table.insert(elements, {label = _U('police_wear'), value = 'afp_wear'})
	end
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'cloakroom', {
		...
		if
			...
			data.current.value == 'prob_constable_wear' or
			data.current.value == 'constable_wear' or
			data.current.value == 'snr_constable_wear' or
			data.current.value == 'l_snr_constable_wear' or
			data.current.value == 'sergeant_i_wear' or
			data.current.value == 'sergeant_ii_wear' or
			data.current.value == 'sergeant_iii_wear' or
			data.current.value == 'boss_wear' or
			data.current.value == 'afp_wear' or
...
function OpenFineMenu(player)
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'fine', {
		...
		align    = 'bottom-right',
		elements = {
			{label = _U('traffic_offences'), value = 0},
			{label = _U('drugs_offences'),   value = 1},
			{label = _U('weapons_offences'), value = 2},
			{label = _U('property_offences'),   value = 3},
			{label = _U('business_corruptions'), value = 4},
			{label = _U('police_offences'), value = 5}
	}}, function(data, menu)
...
Citizen.CreateThread(function()
	while true do
		...
		if isHandcuffed then
			...
			DisableControlAction(0, 21, true) -- Shift Run
	...
	while true do
		...
		if PlayerData.job and PlayerData.job.name == 'police' then
			...
			for k,v in pairs(Config.PoliceStations) do
				...
				if Config.EnablePlayerManagement and PlayerData.job.grade_name == 'boss' or 'boss2' then
...
function RenderVehicleInfo(vehicle)
	...
	if useMilesPerHour then
		vehicleSpeed = vehicleSpeed * 3.6 -- mph
		spdUnits = "mph"
	else
	...
	AddTextComponentString(
		"Vehicle: " .. vehname .. "        Plate: " .. licenseplate .. "\nSpeed: " .. math.ceil(vehicleSpeed)       
	)
	DrawText(0.45, 0.9)
end

--function HandleSpotlight(cam)
--if IsControlJustPressed(0,  then toggle_spotlight) 
--PlaySoundFrontend(-1, "SELECT", "HUD_FRONTEND_DEFAULT_SOUNDSET", false)
--spotlight_state = not spotlight_state
-- end
